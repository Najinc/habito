  ...
  <main class="min-h-screen bg-gradient-to-br from-indigo-100 via-slate-100 to-cyan-100 px-4 py-10">
    <div class="mx-auto w-full max-w-7xl">
      <div class="grid gap-6 lg:grid-cols-1">
        <!-- Search Section -->
        <section class="space-y-6 rounded-3xl bg-white/80 p-6 shadow-soft backdrop-blur md:p-10">
          <header class="space-y-2">
            ...
            <p class="text-slate-600">
              Interface de recherche avec retrieval semantique et reranking pour des resultats plus pertinents.
            </p>
          </header>
              ...
              >
                <div class="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
                  ...
                  <div class="flex shrink-0 items-center gap-2 text-sm">
                    <span
                      class="rounded-lg border px-2 py-1 font-medium"
